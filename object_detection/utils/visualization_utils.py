...
def draw_bounding_box_on_image_array(image,
  ...
  """
  image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
  box_center= draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
...
def draw_bounding_box_on_image(image,
  ...
  box_center = [(left+right)/2.0, (top+bottom)/2.0]
  ...
  # If the total heiht of the display strings added to the top of the bounding
...
def draw_bounding_box_on_image_array_detect(image,
                                       ymin,
                                       xmin,
                                       ymax,
                                       xmax,
  ...
  obj_position = draw_bounding_box_on_image_detect(image_pil, ymin, xmin, ymax, xmax, color, thickness,
                               display_str_list,
                               use_normalized_coordinates)
  np.copyto(image, np.array(image_pil))
...
def draw_bounding_box_on_image_detect(image,
                               ymin,
                               xmin,
                               ymax,
                               xmax,
  ...
  obj_position = [left,right,top,bottom]
...
def visualize_valid_boxes_and_labels_on_image_array(
    image,
    boxes,
    classes,
    scores,
  ...
  for box, color in box_to_color_map.items():
    ...
    obj_position = draw_bounding_box_on_image_array_detect(
        image,
        ymin,
        xmin,
        ymax,
  ...
  return obj_positions, valid_classes

def visualize_realboxes_and_labels_on_image_array(
    image,
    boxes,
    classes,
    scores,
  ...
  for box, color in box_to_color_map.items():
    ...
    box_center = draw_bounding_box_on_image_array(
        image,
        ymin,
        xmin,
        ymax,
